...
class SqueezeNet(object):
    ...
    def __init__(self, save_path=None, sess=None):
        ...
        """
        self.image = tf.placeholder('float',shape=[None,None,None,3],name='input_image') # Why shape=[None,None,None,3]: https://stackoverflow.com/questions/39615197/how-to-set-shape-in-placeholder-for-non-deterministic-array-size
